...
describe('GenderPrismaRepository Integration',() => {
    ...
    describe('error handling',() => {
        it('should handle database connection errors gracefully',async () => {
            ...
            jest.spyOn((disconnectedPrisma as any).gender,'upsert').mockRejectedValue(new Error('Connection failed'))
        ...
        it('should handle constraint violations appropriately',async () => {
            ...
            // which should NOT be allowed for the gender entity as it is unique
            ...
            await expect(repository.save(gender2)).rejects.toThrow()
        })
    })
