...
import {ACCOUNT_REPOSITORY} from '../../accounts/domain/tokens'
import {CATEGORY_REPOSITORY} from '../../categories/domain/tokens'

@Injectable()
export class DashboardDomainService implements DashboardDomainServicePort {
    constructor(
        @Inject('TransactionRepositoryPort') private readonly transactionRepository: any, // TransactionRepositoryPort
        @Inject(ACCOUNT_REPOSITORY) private readonly accountRepository: any, // AccountRepositoryPort
        @Inject(CATEGORY_REPOSITORY) private readonly categoryRepository: any // CategoryRepositoryPort
    ) {}
