...
describe('ProfessionPrismaRepository Integration',() => {
    ...
    describe('error handling',() => {
        it('should handle database connection errors gracefully',async () => {
            ...
            jest.spyOn((disconnectedPrisma as any).profession,'upsert').mockRejectedValue(new Error('Connection failed'))
        ...
        it('should handle constraint violations appropriately',async () => {
            ...
            // which should NOT be allowed for the profession entity as it is unique
            ...
            await expect(repository.save(profession2)).rejects.toThrow()
        })
    })
